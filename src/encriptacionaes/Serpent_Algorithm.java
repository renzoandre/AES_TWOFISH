...
//...........................................................................
     ...
     */
    static final boolean USE_BIT_SLICE_IMPLEMENTATION = false;

    static final int BLOCK_SIZE = 32; // bytes in a Serpent data-block
...
System.out.println();
        ...
        Serpent_Algorithm sa=new Serpent_Algorithm();
        
        String txt="ni idea de este codigo como incrementar la catidad de bytes";
        System.out.println("text original : "+txt);
        String key="12345678";
        byte [] txtb=txt.getBytes();
        byte [] keyb=key.getBytes();
        try {
            byte txtci[]=blockEncrypt(txtb,0,makeKey(keyb));
            System.out.println("texto encriptado : "+new String(Base64.getEncoder().encodeToString(txtci)));
            
            
            
            String ci=new String(Base64.getEncoder().encodeToString(txtci));   
            System.out.println("texto encriptado : "+ci);
            byte cip[]=Base64.getDecoder().decode(ci);
            byte []txtori=blockDecrypt(cip,0,makeKey(keyb));
